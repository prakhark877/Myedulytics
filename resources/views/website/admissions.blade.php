    ...
    <section>
        <div class="card-boxes">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <p>Find reach/match/safety options based on your profile.</p>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <p>Deadlines, tasks, and document checklist.</p>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <p>Build an ATS-friendly resume; manage essay drafts.</p>
                    <button type="button" class="button1">Create</button>
                </div>
            </div>
