...
function uploadMarksheetS3File(fileUploaderid) {
  ...
  if (file) {
      ...
      if ($.inArray(ext, ["jpeg", "jpg", "png", "pdf","docx"]) == -1) {
      ...
      var params = {
          Bucket: bucket,
          Key: "upload/marksheets/" + fileName,  // Removed leading "/"
      ...
      s3.putObject(params, function (err, res) {
          ...
          if (err) {
              ...
              $("#img" + fileUploaderid).attr("src", cloudfront_url + "/upload/marksheets/" + fileName);
              document.getElementById(fileUploaderName).value = "/upload/marksheets/" + fileName;
          }
      });
  } else {
