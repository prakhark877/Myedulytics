...
@section('content')
    <h2>Student Related Questions</h2>
    ...
    <section class="content-header mb-4">
        <div class="d-flex justify-content-between align-items-center flex-wrap">
            ...
            <h1 class="text-white mb-2">
                <i class="fa-solid fa-graduation-cap"></i> Student Questions List
            </h1>
    ...
    <section class="content">
        <div class="quiz-card">
            ...
            <div class="quiz-card-header">
                <h5><i class="fa-solid fa-user-clock"></i> Available questions related to Student</h5>
            </div>
