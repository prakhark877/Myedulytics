  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar" style="width: 100% !important;">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="/admin-dashboard" class="d-block">Super Admin</a>
        </div>
      </div>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              ...
              <li  class="nav-item">
                <a href="/super-admin/student-list" class="nav-link">
         ...
         <li class="nav-item has-treeview">
            <a href="/super-admin/categories" class="nav-link">
              <i class="nav-icon fas fa-copy"></i>
              <p>Categories
                <span class="badge badge-info right">1</span>
              </p>
         ...
         <li class="nav-item has-treeview">
          <a href="/super-admin/subcategories" class="nav-link">
            <i class="nav-icon fas fa-copy"></i>
            <p>Subcategory
              <span class="badge badge-info right">1</span>
            </p>
